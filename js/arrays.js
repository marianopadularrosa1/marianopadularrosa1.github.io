...
const fieldsArrayForm = [
    { id: 1,  fieldId: "nombre", fieldType: "text" , element:"input",placeholder:"",innerHTML:"Nombre",class:"form-control-sm form-control",required:"true"},
    { id: 2,  fieldId: "apellido", fieldType: "text" , element:"input",placeholder:"",innerHTML:"",class:"form-control-sm form-control"},
    { id: 3,  fieldId: "dni", fieldType: "text" , element:"input",placeholder:"",innerHTML:"",class:"form-control-sm form-control"},
    { id: 4,  fieldId: "telefono", fieldType: "number" , element:"input",placeholder:"",innerHTML:"",class:"form-control-sm form-control"},
    { id: 5,  fieldId: "direccion", fieldType: "text" , element:"input",placeholder:"",innerHTML:"",class:"form-control-sm form-control"},
    { id: 6,  fieldId: "email", fieldType: "email" , element:"input",placeholder:"",innerHTML:"",class:"form-control-sm form-control"},
    { id: 7,  fieldId: "fechaNacimiento", fieldType: "date" , element:"input",placeholder:"",innerHTML:"",class:"form-control-sm form-control"},
    ...
    { id: 9,  fieldId: "ingresosMensuales", fieldType: "text" , element:"input",placeholder:"",innerHTML:"",class:"form-control-sm form-control"},
    { id: 10,  fieldId: "antiguedad", fieldType: "text" , element:"input",placeholder:"",innerHTML:"",class:"form-control-sm form-control"},
